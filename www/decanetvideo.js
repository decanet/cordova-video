...
var decanetvideo = {
	...
	startRecording : function(filepath, filename, successFunction, errorFunction) {
		cordova.exec(successFunction, errorFunction, 'decanetvideo', 'startrecording', [filepath, filename]);
	},
